...
export class Migration20241111062448 extends Migration {
	override async up(): Promise<void> {
		this.addSql(
			`create table "product" ("id" varchar(255) not null, "owner_id" varchar(255) not null, "name" varchar(255) not null, "type" varchar(255) not null, constraint "product_pkey" primary key ("id"));`,
		);
